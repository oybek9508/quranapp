		...
		},
		{
			actions: {
				...
				setAudioData: assign({
					...
					surahVersesCount: (context, event) => event?.data?.verseTimings?.length,
				}),
			...
			guards: {
				...
				canRepeatNextAyah: (context) => context.ayahNumber < context.surahVersesCount && !!context.repeatActor,
