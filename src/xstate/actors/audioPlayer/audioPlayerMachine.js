 ...
 *
 * Note
 * - CAN_PLAY and WAITING here. Are not natively triggered by the browser. It's artifial/simulated  onTimeUpdate for the implementation details
        ...
        HIDDEN: {
          ...
          on: {
            ...
            PLAY_RADIO_TRACK: {
              ...
              description:
                "User opens the audio player to play radio of a certain station",
              target: "VISIBLE",
            },
            PLAY_AYAH: [
              {
        ...
        VISIBLE: {
              ...
              states: {
                    ...
                    ACTIVE: {
                      on: {
                        TOGGLE: {
                          ...
                          target:
                            "#audioPlayer.VISIBLE.AUDIO_PLAYER_INITIATED.PLAYING.ACTIVE",
                        },
                        SEEKING: {
                          description:
                        ...
                        END: [
                          {
                            ...
                            target:
                              "#audioPlayer.VISIBLE.AUDIO_PLAYER_INITIATED.ENDED",
                          },
                          {
                            /**
                            ...
                            target:
                              "#audioPlayer.VISIBLE.AUDIO_PLAYER_INITIATED.PLAYING.LOADING",
                          },
                        ],
                      },
                    },
                ...
                PLAYING: {
                  invoke: {
                    ...
                    onError: {
                      target:
                        "#audioPlayer.VISIBLE.AUDIO_PLAYER_INITIATED.PAUSED.ACTIVE",
                    },
                  },
                  ...
                  on: {
                    PLAY_AYAH: [
                      {
                        actions: [
                          "setSurahAndAyahNumbers",
                          "exitRadio",
                          "stopRepeatActor",
                        ],
                        description:
                          "When the user chooses to play an Ayah of another Surah",
                        cond: "isDifferentSurahAndReciter",
                        target:
                          "#audioPlayer.VISIBLE.LOADING_CUSTOM_RECITER_DATA",
                      },
                      {
                        actions: [
                          "setSurahAndAyahNumbers",
                        ...
                        REPEAT_AYAH: {
                          actions: [
                            assign({
                              ...
                              verseDelay: (context, event) => event.verseDelay,
                            }),
                            "pauseAudio",
                            "setAudioPlayerCurrentTime",
                          ],
                          ...
                          target:
                            "#audioPlayer.VISIBLE.AUDIO_PLAYER_INITIATED.DELAYING",
                        },
                        SEEKING: {
                          description:
                            "When the mouse or keyboard keys are clicked to jump forward/backward 5 or 10 seconds or when the user wants to navigate to a specific time.",
                  ...
                  on: {
                    ...
                    PLAY_SURAH: [
                      ...
                      },
                      {
                        ...
                        description:
                          "When the user chooses to play another Surah",
                        cond: "isDifferentSurah",
                        target: "#audioPlayer.VISIBLE.LOADING_RECITER_DATA",
                      },
                      {
                    ...
                    TOGGLE: {
                      description:
                        "User clicks on the play button or presses the space key",
                      target: "PLAYING",
                    },
                    PLAY_RADIO_TRACK: {
                      actions: "setRadioStationDetails",
            ...
            LOADING_RECITER_DATA: {
              ...
              invoke: {
                ...
                onDone: [
                  {
                    ...
                    description:
                      "The API call to get the selected chapter + Surah succeeded",
                    target:
                      "#audioPlayer.VISIBLE.AUDIO_PLAYER_INITIATED.PLAYING.LOADING",
                  },
                ],
                onError: [
                  {
                    description:
                      "The API call to get the selected chapter + Surah failed",
                    target: "FAILED",
                  },
                ],
              },
                ...
                onDone: [
                  {
                    ...
                    description:
                      "The API call to get the selected chapter + Surah succeeded",
                    target:
                      "#audioPlayer.VISIBLE.AUDIO_PLAYER_INITIATED.PAUSED.LOADING",
                  },
                ],
                onError: [
                  {
                ...
                onDone: [
                  {
                    actions: [
                      ...
                      "setAudioPlayerCurrentTime",
                      assign({
                        surah: (context, event) => event.data.surah,
                        ayahNumber: (context, event) => event.data.from,
                        // repeatActor: (context, event) => {
                        //   return spawn(
                        //     createRepeatMachine({
          ...
          on: {
            ...
            PLAY_SURAH: [
              {
                description:
                  "When the users is playing the same surah. Just resume it",
                cond: "isSameSurahAndReciter",
                target: ".AUDIO_PLAYER_INITIATED.PLAYING.ACTIVE",
              },
              {
    ...
    },
    {
      actions: {
        ...
        setRadioStationDetails: assign({
          shouldPlayFromRandomTimeStamp: (context, event) =>
        ...
        setAudioData: assign({
          ...
          surahVersesCount: (context, event) =>
        ...
        setAudioPlayerCurrentTime: (context) => {
          ...
          if (shouldPlayFromRandomTimeStamp) {
            ...
            context.audioPlayer.currentTime =
              milliSecondsToSeconds(timestampFrom);
          }
        },
        ...
        setPlaybackRate: pure((context, event) => {
        ...
        seekToAndRepeat: pure((context, event) => {
          ...
          if (context.repeatActor) {
            actions.push(
              send(
                { type: "REPEAT_SELECTED_AYAH", ayahNumber },
                { to: context.repeatActor.id }
              )
            );
          }
      ...
      guards: {
        ...
        isNotLastVerse: (context) =>
          context.ayahNumber < context.surahVersesCount,
        isNotFirstVerse: (context) => context.ayahNumber !== 1,
        canRepeatPrevAyah: (context) =>
          context.ayahNumber !== 1 && !!context.repeatActor,
        ...
        isDifferentSurahAndReciter: (context, event) => {
          ...
          return (
            context.surah !== event.surah &&
            reciterId !== context.audioData?.reciterId
          );
        },
        isSameAyah: (context, event) =>
          context.ayahNumber === event.ayahNumber &&
          context.surah === event.surah,
      ...
      services: {
        ...
        fetchCustomReciter: (context, event) => {
          // @ts-ignore
          return executeFetchReciter({
            surah: event.surah,
            reciterId: event.reciterId,
          });
        },
        fetchRepeatData: (context, event) =>
          executeFetchReciterFromEvent(context, event),
        initMediaSession: (context) => (callback) => {
          if ("mediaSession" in navigator) {
            getRecitersList(context).then((recitersList) => {
              ...
              getMediaSessionMetaData(context, recitersList).then(
                (metaData) => {
