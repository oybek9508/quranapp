...
import { getChapterIdBySlug, getChapterVerses } from "src/api/quran-chapter-api";
...
import { getToAndFromFromRange, isValidVerseId, isValidVerseNumber, isValidVerseRange } from "src/utils/validator";
	...
	return (
		<DataContext.Provider value={chaptersData}>
			<ReadingPreferenceTab
				...
				quranReaderType={isVerse ? QuranReaderDataType.Verse : QuranReaderDataType.VerseRange}
			/>
